  ...
  return (
    <div className="min-h-screen bg-white flex flex-col font-sans">
      ...
      <main className="flex-grow pt-24">
        {/* HEADER */}
        <section className="bg-gradient-to-r from-primary/8 via-accent/5 to-white py-20 md:py-24 px-6 sm:px-10 lg:px-12 border-b border-primary/10 text-center space-y-4">
          <Reveal from="bottom">
            <span className="text-[10px] font-bold tracking-widest text-accent uppercase font-display inline-block">Contact Us</span>
          </Reveal>
          <Reveal from="bottom" delay={0.1}>
            <h1 className="text-4xl sm:text-5xl font-bold font-serif text-navy tracking-tight leading-tight">
              ...
              <span className="text-primary font-normal italic mt-2 block">We Are Here to Support Your Family.</span>
            </h1>
          </Reveal>
          <Reveal from="bottom" delay={0.2}>
            <p className="text-dark/70 text-base max-w-2xl mx-auto leading-relaxed font-light">
