...
export function Chatbot() {
  ...
  const chatbotDatabase = [
    ...
    },
    {
      ...
      response: "We offer 4 flexible subscription plans (billed monthly, no setup fees, cancel anytime with a 7-day notice):\n• Basic Care (₹4,999/mo): 1 wellness check-in, medication reminders, monthly updates.\n• Premium Care (₹7,999/mo): 2 check-ins, hospital transport & assistance, 1 basic property inspection.\n• Complete Care (₹11,999/mo): 4 check-ins, blood bank coordination, hospital support, property monitoring.\n• NRI Prime (₹22,999/mo): 8 check-ins, full hospital suite, 2 property inspections, selling & construction oversight, legal assistance.\n\nNote: Additional services, extended hospital assistance, outstation visits, travel expenses, and third-party professional charges may be billed separately based on requirements.\n\nUse coupon WELCOME500 for a flat ₹500 off or AASARA15 for 15% off! Custom plans are available for unique requirements."
    },
    {
    ...
    {
      keywords: ['service', 'do you do', 'wellness', 'health', 'property', 'asset', 'estate', 'maintenance', 'repair', 'tenant', 'emergency', 'hospital', 'doctor', 'ambulance', 'errand', 'blood', 'transport', 'selling', 'construction', 'rental', 'iv', 'update', 'evening', 'legal', 'fiduciary', 'poa', 'power of attorney', 'will', 'title', 'tax', 'nre', 'nro', 'repatriation', 'inheritance'],
      response: "Aasara provides comprehensive local care services in India:\n\n❤️ Parent Care:\n• Hospital transport (pick-up & return home)\n• At-hospital assistance & in-patient care support\n• Blood bank priority tie-up & IV nursing assistance\n• Monthly wellness check-ins & WhatsApp updates\n\n🏠 Property Management:\n• Monthly GPS-verified physical inspections with photo/video\n• Structural & monsoon health checks, repairs & painting\n• Tenant finding, onboarding, rent collection & selling oversight\n\n⚖️ Legal Services:\n• Title verification, Encumbrance Certificate (EC) retrieval\n• Special Power of Attorney (SPOA) drafting & registration\n• Inheritance, will registration & tenant dispute resolution\n\n🏛️ Fiduciary Services:\n• NRE/NRO bank account coordination & repatriation paperwork (Form 15CA/CB)\n• Estate administration & statutory dues/tax payments\n• Rental ledger auditing & capital gains tax support"
    },
    {
